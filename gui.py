...
def generate():
    print(logic.generate(states, kara))
...
root.bind("<Up>", lambda event:rotkara(0))
root.bind("<Right>", lambda event:rotkara(1))
root.bind("<Down>", lambda event:rotkara(2))
root.bind("<Left>", lambda event:rotkara(3))
